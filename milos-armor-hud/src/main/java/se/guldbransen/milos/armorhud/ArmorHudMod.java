package se.guldbransen.milos.armorhud;
...
import se.guldbransen.milos.armorhud.compat.BedrockifyCompat;
import se.guldbransen.milos.armorhud.config.ArmorHudConfig;
import se.guldbransen.milos.armorhud.mixin.InventoryMenuAccessor;
...
public final class ArmorHudMod implements ModInitializer {
    public static final String MOD_ID = "milos-armor-hud";
